...
public:
    ...
    static QMap<QString, QMap<QString, QString>> keyword_Exten_MainSecTitle, speciesMSTAbbreviationName, habitatTypePlantAssociationMSTNumberAbbreviation, forestMSTNumberName;
