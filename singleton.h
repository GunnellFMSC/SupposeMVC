...
private:
  ...
  static QBasicAtomicPointer<T*(void)> create; // altered to Kheaactua's suggestion https://wiki.qt.io/Talk:Qt_thread-safe_singleton
...
// altered to Kheaactua's suggestion https://wiki.qt.io/Talk:Qt_thread-safe_singleton
